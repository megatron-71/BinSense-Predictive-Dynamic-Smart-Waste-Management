...
- **Road Network Cache:** Downloaded OpenStreetMap road network for Bengaluru Central (CBD / Cubbon Park area: `north=12.985, south=12.965, east=77.610, west=77.585`) and cached offline in [`binsense/data/road_graph.graphml`](file:///c:/Project/SWM/binsense/data/road_graph.graphml) (664 nodes, 1,368 edges).
...
- **Datasets:** Exported to [`binsense/data/bins.csv`](file:///c:/Project/SWM/binsense/data/bins.csv), [`binsense/data/vehicles.csv`](file:///c:/Project/SWM/binsense/data/vehicles.csv), and [`binsense/data/fill_history.csv`](file:///c:/Project/SWM/binsense/data/fill_history.csv).
